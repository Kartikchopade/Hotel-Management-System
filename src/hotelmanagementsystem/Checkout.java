...
public class Checkout extends JFrame implements ActionListener
{
    ...
    Checkout()
    {
        ...
        ImageIcon i1=new ImageIcon(ClassLoader.getSystemResource("hotelmanagementsystem/tick.png"));
        ...
        ImageIcon i4=new ImageIcon(ClassLoader.getSystemResource("hotelmanagementsystem/sixth.jpg"));
    ...
    public void actionPerformed(ActionEvent ae)
    {
        if(ae.getSource()==b1)
        {
            ...
            try
            {
              ...
              JOptionPane.showMessageDialog(null,"Checkout Sucessfully");
